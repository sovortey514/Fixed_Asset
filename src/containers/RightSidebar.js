...
function RightSidebar() {
  ...
  return (
    <div
      className={
        " fixed overflow-hidden z-20 bg-opacity-25 inset-0 transform ease-in-out " +
        (isOpen
    ...
    >
      <section
        className={
          "w-80 md:w-96  right-0 absolute h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " +
